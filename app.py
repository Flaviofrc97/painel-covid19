...
app.layout = html.Div([
    html.Div([
        html.Div([
            html.Img(src=app.get_asset_url('coronavirus-covid-19.png'),
                     id='corona-image',
                     style={
                         "height": "60px",
                         "width": "auto",
        ...
        html.Div([
            html.Div([
                html.H1("PAINEL COVID-19", style={"margin-bottom": "0px", 'color': 'white'}),
                html.H6("Fonte dos dados: Our World in Data", style={"margin-top": "0px", 'color': 'white'}),
            ])
        ], className="one-half column", id="title"),

        html.Div([
            html.H6('Ultima atualização: ' + str(covid_data_1['date'].iloc[-1].strftime("%d %B, %Y")),
                    style={'color': 'white'}),
    ...
    html.Div([
        ...
        html.Div([
            html.H6(children='Morte total (mundo)',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
        ...
        html.Div([
            html.H6(children='Recuperados (mundo)',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
    ...
    html.Div([
        html.Div([
                    ...
                    html.P('País:', className='fix_label',  style={'color': 'white'}),
                     ...
                     dcc.Dropdown(id='w_countries',
                                  ...
                                  options=[{'label': c, 'value': c}
                                           for c in np.sort((covid_data['Country/Region'].unique()))], className='dcc_compon'),

                     html.P('Novos casos : ' + '  ' + ' ' + str(covid_data_2['date'].iloc[-1].strftime("%d %B, %Y")) + '  ', className='fix_label',  style={'color': 'white', 'text-align': 'center'}),
    ...
    return {
        'data': [go.Bar(x=covid_data_3[covid_data_3['Country/Region'] == w_countries]['date'].tail(30),
                 ...
                 go.Scatter(x=covid_data_3[covid_data_3['Country/Region'] == w_countries]['date'].tail(30),
                            ...
                            mode='lines',
                            name='Média contínua dos últimos sete dias - casos confirmados diariamente',
        ...
        'layout': go.Layout(
             ...
             paper_bgcolor='#1f2c56',
             title={
                'text': 'Casos confirmados ultimos 30 dias em ' + (w_countries),
                'y': 0.93,
                'x': 0.5,
                'xanchor': 'center',
                'yanchor': 'top'},
             ...
             yaxis=dict(title='<b>Casos confirmados diariamente</b>',
                        color='white',
                        showline=True,
                        showgrid=True,
                        showticklabels=True,
...
def update_graph(w_countries):
    ...
    return {
        'data': [go.Scattermapbox(
                         ...
                         hoverinfo='text',
                         hovertext=
                         '<b>País</b>: ' + covid_data_3['Country/Region'].astype(str) + '<br>' +
                         '<b>Longitude</b>: ' + covid_data_3['Long'].astype(str) + '<br>' +
                         '<b>Latitude</b>: ' + covid_data_3['Lat'].astype(str) + '<br>' +
                         '<b>Confirmados</b>: ' + [f'{x:,.0f}' for x in covid_data_3['confirmed']] + '<br>' +
                         '<b>Mortes</b>: ' + [f'{x:,.0f}' for x in covid_data_3['death']] + '<br>' +
                         '<b>Recuperados</b>: ' + [f'{x:,.0f}' for x in covid_data_3['recovered']] + '<br>' +
                         '<b>Ativo</b>: ' + [f'{x:,.0f}' for x in covid_data_3['active']] + '<br>'
